...
cannot_move_from_zoc_to_zoc : moveTo Allies [ (Bautzen.GameUnit.r13_5dp, Hex 3 4), (Bautzen.GameUnit.g21_20pz, Hex 3 5) ] TestMap "13/5DP" (Hex 4 4) = Left (MoveFromZocToZoc Bautzen.GameUnit.r13_5dp (Hex 4 4))
...
armored_moving_on_hill_is_forbidden : moveTo Axis [ (Bautzen.GameUnit.g21_20pz, Hex 3 4) ] TestMap "21/20Pz" (Hex 2 3) = Left (ForbiddenTerrain (Hex 3 4) (Hex 2 3))
...
moving_out_of_ZoC_adds_one_PM_to_move : moveTo Allies [ (Bautzen.GameUnit.r13_5dp, Hex 3 4), (Bautzen.GameUnit.g21_20pz, Hex 3 5) ] TestMap "13/5DP" (Hex 2 3) = Right (Moved Bautzen.GameUnit.r13_5dp (Hex 3 4) (Hex 2 3) (One (Two (One (One Zero)))))
...
unit_cannot_move_if_not_enough_MP : moveTo Axis [ (Bautzen.Game.Move.g21_20pz_no_mp, Hex 3 4) ] TestMap "21/20Pz" (Hex 3 5) = Left (NotEnoughMPs Bautzen.Game.Move.g21_20pz_no_mp (Hex 3 4) (Hex 3 5) 4)
