...
nextSegment (MkGame (MkGameState _ Allies Setup _) _) = Right AlliesSetupDone
nextSegment (MkGame (MkGameState _ Axis Setup _) _) = Right (SegmentChanged Setup Supply)
